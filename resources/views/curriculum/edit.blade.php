                                            ...
                                            @if($turma->classschedules()->where("diasmnocp",$dia)->where("horent",explode(" ",$h)[0])->where("horsai",explode(" ",$h)[2])->get()->isNotEmpty())
                                                ...
                                                @elseif(!in_array($turma->id, $done))
                                                    ...
                                                    >
                                                        ...
                                                        @foreach($schoolclasses[$nomhab]->filter(function($t)use($coddis){return $t->coddis == $coddis;}) as $turma2)
                                    ...
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle;">
                                            @php 
                                                ...
                                                $codturs = [];
                                            @endphp
                                            @foreach($schoolclasses[$nomhab] as $turma2)
...
@section('javascripts_bottom')
  @parent
    ...
    <script>
        ...
        $('#attachscModal').on('show.bs.modal', function (event) {
            var button = $(event.relatedTarget);
            $("option[value='"+button.data("codhab")+"']").prop("selected", true);
        });
