...
return [
    ...
    */
    'room_allocation' => [
        ...
        'claustrophobia_penalty' => (float) env('ROOM_ALLOCATION_CLAUSTROPHOBIA_PENALTY', 7.0),
        ...
        'split_class_penalty' => (float) env('ROOM_ALLOCATION_SPLIT_CLASS_PENALTY', 97780.0),
        'split_cohort_penalty' => (float) env('ROOM_ALLOCATION_SPLIT_COHORT_PENALTY', 9635.0),
        'unassigned_penalty' => (float) env('ROOM_ALLOCATION_UNASSIGNED_PENALTY', 1745715.0),
